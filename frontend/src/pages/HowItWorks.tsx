      ...
      <div className="max-w-5xl mx-auto py-16 px-6">
        ...
        <div className="bg-[#111] border border-gray-800 rounded-xl p-8 md:p-12 space-y-8">
          {[
            ...
            { title: "4. 72-Hour Verification and Inspection", desc: "Winning bidders are expected to proceed in good faith after a reasonable inspection of the vehicle. The winning dealer and seller must make arrangements for inspection within 72 hours of the auction end. Unless otherwise agreed by the parties, the seller is responsible for bringing the vehicle to the winning dealer's dealership or another mutually agreed inspection location. The purpose of this period is to verify that the vehicle materially matches the information provided in the listing, including condition, title status, and material representations. This verification period is not intended to create a general right to renegotiate or walk away." },
